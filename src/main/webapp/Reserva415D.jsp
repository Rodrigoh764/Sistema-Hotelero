...
<head>
<meta charset="UTF-8">
<title>Información habitación: Suite presidencial</title>
				...
				<div id="carouselExampleControls" class="carousel slide"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="images/415D.jpg" style="height: 400px">
						</div>
						<div class="carousel-item">
							<img src="images/415D-2.jpg" style="height: 400px">
						</div>
						<div class="carousel-item">
							<img src="images/415D-3.jpg" style="height: 400px">
						</div>
						<div class="carousel-item">
							<img src="images/415D-4.jpg" style="height: 400px">
						</div>
					</div>
				...
				<form method="post" action="ReservarHabitacion"
							...
							<div class="accordion-item" style="background: #E2E2E2;">
								...
								<div id="flush-collapseOne" class="accordion-collapse collapse"
									...
									<div class="accordion-body">
										...
										<i class="fa-solid fa-martini-glass-empty"></i> Minibar <br>
										 Acceso al lounge ejecutivo <br>
										<i class="fa-solid fa-shower"></i> Tina de hidromasaje <br>
										 Sala de estar
									</div>
								</div>
							</div>				
					...
					<div class="form-group form-button" style="text-align: center">
						<a class="btn btn-primary" href="Index.jsp" role="button"
							...
							<input type="submit" name="signin" id="signin" class="form-submit" value="Reservar" />
					</div>
				</form>
			</div>
		</div>
