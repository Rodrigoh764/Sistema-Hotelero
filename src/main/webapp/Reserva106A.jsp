...
<head>
<meta charset="UTF-8">
<title>Información habitación: Suite junior</title>
				...
				<div id="carouselExampleControls" class="carousel slide"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="images/106A.jpg" style="height: 400px">
						</div>
						<div class="carousel-item">
							<img src="images/106A-2.jpg" style="height: 400px">
						</div>
						<div class="carousel-item">
							<img src="images/106A-3.jpg" style="height: 400px">
						</div>
					</div>
							...
							<div class="accordion-item" style="background: #E2E2E2;">
								...
								<div id="flush-collapseOne" class="accordion-collapse collapse"
									...
									<div class="accordion-body">
										<i class="fa-solid fa-expand"></i> 50 metros cuadrados <br>
										...
										<i class="fa-solid fa-utensils"></i> Desayuno a la carta <br>
										<i class="fa-solid fa-tv"></i> Canales por cable <br>
										<i class="fa-solid fa-shower"></i> Baño privado <br>
										<i class="fa-solid fa-computer"></i> Escritorio grande
									</div>
								</div>
							</div>				
						</div>
